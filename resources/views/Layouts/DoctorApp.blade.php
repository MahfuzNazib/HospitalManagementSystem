...
<head>
  ...
  ******************************************** -->
  ...
  <!-- //Some Database Query Here To Show User Informations -->
  <?php 
    //Check New Notice
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('Doctor.index')}}">
      ...
      <!-- Investigation -->
      <li class="nav-item">
        <a class="nav-link" href="{{route('Doctor.appointmentList')}}">
          <i class="fas fa-user-nurse"></i>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="/Notice/{{ $notice->id }}">
                  ...
                  <div>
                    <div class="small text-gray-500">{{ $notice->date }}</div>
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <a class="dropdown-item" href="{{ route('Doctor.myProfile') }}">
                ...
                <a class="dropdown-item" href="{{route('Logout.index')}}" data-toggle="modal" data-target="#logoutModal">
